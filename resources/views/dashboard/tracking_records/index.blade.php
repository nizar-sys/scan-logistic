...
@section('action_btn')
    ...
    @endphp
    <a href="{{ $url }}" class="btn btn-sm btn-danger" id="btn-report">Buat Laporan</a>
    <a href="{{ route('tracking-records.create') }}" class="btn btn-sm btn-default">Tambah Data</a>
    <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#filter-date-modal">Filter</button>
    @if ($startDate || $endDate)
        <a href="{{ route('tracking-records.index') }}" class="btn btn-sm btn-danger">Reset</a>
    @endif
@endsection
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#trackingrecord-table').DataTable();
            ...
            $('#filter-btn').on('click', function(e) {
                ...
                var urlReport = "{{ route('tracking-records.reports') }}";
